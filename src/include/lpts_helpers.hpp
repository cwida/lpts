...
/// Dialect-aware variants. SPARK/HIVE use backtick quoting; DUCKDB/POSTGRES/
/// TRINO_PRESTO fall back to `KeywordHelper::WriteOptionallyQuoted` (matching
/// the dialect-blind overloads above).
